...
int main()
{
    ...
    if (fichier != NULL) // On peut lire et écrire dans le fichier
    {
        ...
        int nbNoeuds = puissance(cardinalE)-1;
        ...
        while (x <= nbNoeuds)
        {
            ...
            while (y <= nbNoeuds)
            {
                ...
                numTest++;
                if (unionPratique(x,y) == x && rkMin[x] > rkMin[y])
                {
                    rkMin[y] = rkMin[x];
                ...
                numTest++;
                if (unionPratique(x,y) == x && rkMax[y] < rkMax[x])
                {
                    rkMax[x] = rkMax[y];
                ...
                numTest++;
                if (unionPratique(x,y) == y && rkMin[y] > rkMin[x])
                {
                    rkMin[x] = rkMin[y];
                ...
                numTest++;
                if (unionPratique(x,y) == y && rkMax[y] > rkMax[x])
                {
                    rkMax[y] = rkMax[x];
                ...
                // (RS5) si rkMax(X) + rkMax(Y) − rkMin(X ∩ Y) < rkMax(X ∪ Y) alors rkMax(X ∪ Y) prend la valeur de rkMax(X) + rkMax(Y) − rkMin(X ∩ Y)
                numTest++;
                if (rkMax[x] + rkMax[y] - rkMin[unionPratique(x,y)] < rkMax[interPratique(x,y)])
                {
                    rkMax[interPratique(x,y)] = rkMax[x] + rkMax[y] - rkMin[unionPratique(x,y)];
                    printf("Test %d : RS5 de %s sur %s  ->  rkMax(%s) = %d  ->  %s %d/%d\n", numTest, nomNoeud[x], nomNoeud[y], nomNoeud[interPratique(x,y)], rkMax[interPratique(x,y)], nomNoeud[interPratique(x,y)], rkMax[interPratique(x,y)], rkMin[interPratique(x,y)]);
                ...
                // (RS6) si rkMax(X) + rkMax(Y) − rkMin(X ∪ Y) < rkMax(X ∩ Y) alors rkMax(X ∩ Y) prend la valeur de rkMax(X) + rkMax(Y) − rkMin(X ∪ Y)
                numTest++;
                if (rkMax[x] + rkMax[y] - rkMin[interPratique(x,y)] < rkMax[unionPratique(x,y)])
                {
                ...
                // (RS7) si rkMin(X ∩ Y) + rkMin(X ∪ Y) − rkMax(Y) > rkMin(X) alors rkMin(X) prend la valeur de rkMin(X ∩ Y) + rkMin(X ∪ Y) − rkMax(Y)
                numTest++;
                if (rkMin[unionPratique(x,y)] + rkMin[interPratique(x,y)] - rkMax[y] > rkMin[x])
                {
                ...
                // (RS8) si rkMin(X ∩ Y) + rkMin(X ∪ Y) − rkMax(X) > rkMin(Y) alors rkMin(Y) prend la valeur de rkMin(X ∩ Y) + rkMin(X ∪ Y) − rkMax(X)
                numTest++;
                if (rkMin[unionPratique(x,y)] + rkMin[interPratique(x,y)] - rkMax[x] > rkMin[y])
                {
